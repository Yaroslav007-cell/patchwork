...
a = Tile(1, 4, piece).get_all_configuration()
...
def player_actions(piece_):
    ...
    # global field_1  #
    # global field_2  #
    # global field_imaginary_1  #
    # global field_imaginary_2  #
    global colum_1
    global string_1
    global colum_2
    global string_2
    ...
    if person == 1:
        # print("одит первый")
        start_x = human1["start_x"]
        start_y = human1["start_y"]

        field = human1["field"]
        field_imaginary = human1["field_imaginary"]

        colum = colum_1
        string = string_1
    else:
        # print("ходит второй")
        start_x = human2["start_x"]
        start_y = human2["start_y"]

        field = human2["field"]
        field_imaginary = human2["field_imaginary"]
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            if person == 1:
                human1["field"] = field
                human1["field_imaginary"] = field_imaginary
            else:
                human2["field"] = field
                human2["field_imaginary"] = field_imaginary
            ...
            if event.key == pygame.K_q:
                ...
                if v == 0:
                    a = Tile(1, 4, piece_local).get_all_configuration()
                v += 1
                piece_local = a[v%8]
                print(piece_local)
...
while True:    
    player_actions(piece)
    # score_1 = 
    # a = {1: 101, 2: 102, 3: 103}
    # piece = ALL_TILES[choice(list(ALL_TILES.keys()))]['size']
    # print(type(choice(list(ALL_TILES.keys()))))
