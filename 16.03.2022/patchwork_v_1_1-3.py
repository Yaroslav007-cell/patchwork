...
def draw_dey(field, start_x, start_y, color_1=red, color_2=grey):
    for row in range(9):
        for col in range(9):
...
def draw_mnim(field_imaginary, start_x, start_y):
    for row in range(9):
        for col in range(9):
...
draw_dey(field_1, start_x1, start_y1, color_2=grey_bright)

# отрисовка поля для второго
draw_dey(field_2, start_x2, start_y2)
...
def player_actions(human):
    ...
    for event in pygame.event.get():
        if event.type == pygame.QUIT:
            ...
            draw_dey(field, start_x, start_y,  color_2=grey_bright, color_1=random_color)

            # отрисовка мнимого
            draw_mnim(field_imaginary, start_x, start_y)
            ...
            draw_dey(field, start_x, start_y, color_1=random_color)
            ...
            if person == 1:
                person = 2
                draw_dey(human2["field"], start_x2, start_y2, color_2=grey_bright, color_1=random_color)

            else:
                person = 1
                draw_dey(human1["field"], start_x1, start_y1, color_2=grey_bright, color_1=random_color)
            ...
            if event.key == pygame.K_q:
                ...
                # отрисовка действительного
                draw_dey(field, start_x, start_y, color_2=grey_bright)
