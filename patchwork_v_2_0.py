...
side = 40/1980 * infoObject.current_w  # сторона квадратика
side_enlarged = height_enlarged = 50/1980 * infoObject.current_w
margin = 1/4 * side
margin_enlarged = 1/4 * side_enlarged

# print(side)
# print(margin)

# field_size = 9*side + 10*margin
field_size = 9*round(side) + (9+1)*round(margin)
...
start_middle_x1 = middle_x - 0.45 * middle_x
start_middle_y1 = 0.4 * size[1]

start_middle_x2 = middle_x + 0.45 * middle_x
start_middle_y2 = 0.4 * size[1]


start_x1 = start_middle_x1 - field_size/2
start_y1 = start_middle_y1 - field_size/2
start_x1_enlaged = start_middle_x1 - field_size_enlarged/2
start_y1_enlaged = start_middle_y1 - field_size_enlarged/2

start_x2 = start_middle_x2 - field_size/2
start_y2 = start_middle_y2 - field_size/2
start_x2_enlaged = start_middle_x2 - field_size_enlarged/2
start_y2_enlaged = start_middle_y2 - field_size_enlarged/2
...
name_color_scheme = "Random color"
...
def draw_dey(field, start_x, start_y, color_square=red, color_field=grey, side=40, margin=10):
...
def draw_mnim(field_imaginary, start_x, start_y, side=40, margin=10, imaginary_color=pink):
    for row in range(9):
        for col in range(9):
